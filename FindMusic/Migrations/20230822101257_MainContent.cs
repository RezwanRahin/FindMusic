        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Episodes_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Timestamps_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tracks_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Tracks_Timestamps_TimestampId",
                        column: x => x.TimestampId,
                        principalTable: "Timestamps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Episodes_ApplicationUserId",
                table: "Episodes",
                column: "ApplicationUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Timestamps_ApplicationUserId",
                table: "Timestamps",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Timestamps_EpisodeId",
                table: "Timestamps",
                column: "EpisodeId");

            migrationBuilder.CreateIndex(
                name: "IX_Timestamps_MovieId",
                table: "Timestamps",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_Tracks_ApplicationUserId",
                table: "Tracks",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Tracks_TimestampId",
                table: "Tracks",
                column: "TimestampId");
